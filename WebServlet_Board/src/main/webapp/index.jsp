<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="javax.sql.DataSource"%>          <!-- 그대로 javax.sql -->
<%@page import="javax.naming.InitialContext"%>   <!-- 그대로 javax.naming -->
<%@page import="javax.naming.Context"%>          <!-- 그대로 javax.naming -->
